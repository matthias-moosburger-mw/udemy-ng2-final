System.register(['@angular/router', './user-form.component', './users.component', '../can-deactivate-on-dirty'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var router_1, user_form_component_1, users_component_1, can_deactivate_on_dirty_1;
    var usersRouting;
    return {
        setters:[
            function (router_1_1) {
